...
$(function(){
    ...
    function GetCompanyList(){
        ...
        $.ajax({
            type: "POST",
            url: "../newhireaccess/newhire-access-process.php",
            data: {data:param} ,
    ...
    $('#Submit').click(function(){
        ...
        if (CheckInput() === true) {
            ...
            param = JSON.stringify(param);
                     ...
                     swal({
                          title: "Are you sure?",
                          text: "You want to add this new hire employee?",
                          icon: "success",
                          buttons: true,
                          dangerMode: true,
                        })
                        .then((addNewHire) => {
                          if (addNewHire) {
                            ...
                            swal({text:"You cancel your addition of new hire!!",icon:"error"});
                          }
                        });
